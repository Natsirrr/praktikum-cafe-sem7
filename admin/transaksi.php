...
$transaksi = mysqli_query($conn, "SELECT T.*, U.nm_user FROM tbl_transaksi T, tbl_user U WHERE T.id_user = U.id_user ORDER BY T.waktu DESC");
                                    ...
                                    <table class="table table-sm mb-0 text-black">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="align-middle minw200">User</th>
                                        ...
                                        <tbody id="orders">
                                            ...
                                            <tr class="btn-reveal-trigger">
                                                ...
                                                <td class="py-2"><?php echo $row_transaksi["nm_user"] ?></td>
                                                <td class="py-2">
