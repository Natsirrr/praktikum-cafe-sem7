...
$produk = mysqli_query($conn, "SELECT * FROM tbl_produk WHERE status = 1 ORDER BY id_produk DESC");
        ...
        ***********************************-->
        <div class="content-body">
            <div class="container-fluid">
                ...
                <div class="my-3">
                    <a class="btn btn-secondary btn-lg" href="produk-tambah.php">Tambah Produk</a>
                </div>
                <?php if ($jml_produk == 0) { ?>
